"use strict";$(function(){$(".burger").on("click",function(){$(".navigation, .burger").toggleClass("navigation-active"),$("body").toggleClass("lock")})});
"use strict";$(function(){$(".counter__input").keydown(function(n){n.preventDefault()});var n=$(".counter__controls"),e=($(".counter__input"),1);n.on("click",function(n){n.preventDefault();var t=n.target;if($(t).hasClass("counter__btn"))if($(t).hasClass("counter__btn-plus")){if(20<=$(t).parent().parent().children().val())return;$(t).parent().parent().children().val(e+=1)}else{if($(t).parent().parent().children().val()<=0)return;$(t).parent().parent().children().val(--e)}})});
"use strict";$(function(){function o(n,i){$(n).on("click",function(o){o.preventDefault(),n.find(".arrow").toggleClass("active-dropdown"),"block"===$(i).css("display")?$(i).slideUp("slow"):($(i).slideUp("slow"),$(i).slideDown("slow"))})}var n;new o($(".dropdown-link"),".dropdown"),new o($(".sorting-catalog__link"),$(".sorting-catalog__controls")),n=$(".filter__link"),$(n).on("click",function(o){o.preventDefault(),$(this).siblings().slideToggle(),$(this).find(".arrow").toggleClass("active-dropdown")})});
"use strict";$(function(){$(".form").submit(function(r){r.preventDefault();var t=$(r.currentTarget),a=t.find("[name='mail']");a.removeClass("input__error"),""===a.val().trim()&&a.addClass("input__error"),0===t.find(".input__error").length&&$.ajax({ulr:"",method:"post",data:{mail:a.val()}})})});
"use strict";$(function(){$(".slider__list").slick({arrows:!1,dots:!0,adaptiveHeight:!0,autoplay:!0,autoplaySpeed:3e3}),$(".product__hero").slick({slidesToShow:4,responsive:[{breakpoint:768,settings:{slidesToShow:3}},{breakpoint:480,settings:{slidesToShow:1}}]}),$(".section-info__news").slick({slidesToShow:3,appendArrows:$(".news"),responsive:[{breakpoint:768,settings:{slidesToShow:2}},{breakpoint:480,settings:{slidesToShow:1}}]}),$(".blog__news").slick({dots:!0,rows:4,slidesPerRow:3,arrows:!0,appendArrows:$(".controls-slider__arrow"),appendDots:$(".controls-slider__arrow"),responsive:[{breakpoint:768,settings:{rows:6,slidesPerRow:2}},{breakpoint:480,settings:{rows:4,slidesPerRow:1}}]}),$(".catalog__product").slick({dots:!0,rows:6,slidesPerRow:3,arrows:!0,appendArrows:$(".controls-slider__arrow"),appendDots:$(".controls-slider__arrow"),responsive:[{breakpoint:480,settings:{rows:6,slidesPerRow:1}}]}),$(".card-bg").slick({fade:!0,asNavFor:".card-sm",arrows:!1}),$(".card-sm").slick({slidesToShow:3,asNavFor:".card-bg",centerMode:!0,variableWidth:!0,appendArrows:$(".card-product__controls"),responsive:[{breakpoint:480,settings:{slidesToShow:3}}]})});
...
"use strict";!function(o){function e(t,o){var e,u;1<t.originalEvent.touches.length||(t.preventDefault(),e=t.originalEvent.changedTouches[0],(u=document.createEvent("MouseEvents")).initMouseEvent(o,!0,!0,window,1,e.screenX,e.screenY,e.clientX,e.clientY,!1,!1,!1,!1,0,null),t.target.dispatchEvent(u))}var u,t,n,c;o.support.touch="ontouchend"in document,o.support.touch&&(t=o.ui.mouse.prototype,n=t._mouseInit,c=t._mouseDestroy,t._touchStart=function(t){!u&&this._mouseCapture(t.originalEvent.changedTouches[0])&&(u=!0,this._touchMoved=!1,e(t,"mouseover"),e(t,"mousemove"),e(t,"mousedown"))},t._touchMove=function(t){u&&(this._touchMoved=!0,e(t,"mousemove"))},t._touchEnd=function(t){u&&(e(t,"mouseup"),e(t,"mouseout"),this._touchMoved||e(t,"click"),u=!1)},t._mouseInit=function(){var t=this;t.element.bind({touchstart:o.proxy(t,"_touchStart"),touchmove:o.proxy(t,"_touchMove"),touchend:o.proxy(t,"_touchEnd")}),n.call(t)},t._mouseDestroy=function(){var t=this;t.element.unbind({touchstart:o.proxy(t,"_touchStart"),touchmove:o.proxy(t,"_touchMove"),touchend:o.proxy(t,"_touchEnd")}),c.call(t)})}(jQuery);
"use strict";$(function(){$(".filter__price").slider({animate:"fast",range:!0,min:0,max:5900,values:[1500,5e3],slide:function(e,i){$(".filter-left").val(i.values[0]+"$"),$(".filter-right").val(i.values[1]+"$")}}),$(".filter-left").val($(".filter__price").slider("values",0)+"$"),$(".filter-right").val($(".filter__price").slider("values",1)+"$"),$(".filter__price-container").on("change",function(){var e=$(".filter-left").val().replace(/[^0-9]/g,""),i=$(".filter__price").slider("option","min"),l=$(".filter__price").slider("values",1),r=$(".filter-right").val().replace(/[^0-9]/g,""),t=$(".filter__price").slider("option","max"),a=$(".filter__price").slider("values",0);l<e&&(e=l),e<i&&(e=i),""==e&&(e=0),r<a&&(r=a),t<r&&(r=t),""==r&&(r=0),$(".filter-left").val(e),$(".filter-right").val(r),e!=a&&$(".filter__price").slider("values",0,e),r!=l&&$(".filter__price").slider("values",1,r)});var e=$(".catalog-header__link"),i=$(".aside");$(e).on("click",function(e){e.preventDefault(),$(i).slideToggle()})});
...
"use strict";$(function(){var a=$(".tabs-card__list"),_=$(".tabs-card__text");a.on("click",function(a){var t=a.target,s=a.target.dataset.tab;if(a.preventDefault(),$(t).closest(".tabs-card__item")||console.log(!1),$(t).closest(".tabs-card__item")&&!$(t).hasClass("tabs-card__item")&&!$(t).hasClass("tabs-card__list")){$(".tabs-card__item").removeClass("tabs-card__item-active"),$(t).closest(".tabs-card__item").addClass("tabs-card__item-active");for(var e=0;e<_.length;e++){var c=_[e],r=$(c).hasClass(s);r&&$(c).removeClass("tabs-hiden"),r||$(c).addClass("tabs-hiden")}}})});